@extends('layouts/app', ['activePage' => 'login', 'title' => 'Light Bootstrap Dashboard Laravel by IVAN TOTNAK'])

@section('content')
    <div class="full-page section-image" data-color="black" style="background-image:url('{{ asset('light-bootstrap/img/tcu.jpg') }}');background-size:cover;" data-image="{{asset('light-bootstrap/img/full-screen-image-2.jpg')}}" data-image="{{ asset('light-bootstrap/img/full-screen-image-2.jpg') }}">
