@extends('layouts.app', ['activePage' => 'user', 'title' => 'TCU Foundation', 'navName' => 'User Profile',
...
<div class="content">
    <div class="container-fluid">
        <div class="section-image" id="candidateContainer">
    ...
    $(document).ready(function() {
        var id = {{ $candidate[0]->no }};
            $.ajax({
                url: '/api/dualCandidate/'+id,
                method: 'GET',
                beforeSend: function() {
                    $("#loader").show();
                },
